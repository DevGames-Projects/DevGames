        ...
        CredentialsProvider({
            ...
            async authorize(credentials, req) {
                if (credentials?.type === 'logIn'){
                    ...
                    const res = await fetch(`https://dev-games-a942zwefy-devgames-projects-7c6c1a38.vercel.app/api/auth/logIn`, {
                        method: "POST",
                        headers: {
                    ...
                    const res = await fetch(`https://dev-games-a942zwefy-devgames-projects-7c6c1a38.vercel.app/api/auth/signIn`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            'Accept': 'application/json'
